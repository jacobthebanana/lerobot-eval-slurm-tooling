#!/usr/bin/env bash
# run_eval_pi05_finetuned_libero.sh — Evaluate lerobot/pi05_libero_finetuned_v044 (libero_spatial only)
#
# Usage:
#   bash run_eval_pi05_finetuned_libero.sh
#   bash run_eval_pi05_finetuned_libero.sh --n-episodes 10 --batch-size 5
set -euo pipefail
...
JOB_NAME="pi05-finetuned-libero-spatial"
POLICY_PATH="lerobot/pi05_libero_finetuned_v044"
OUTPUT_BASE="pi05-finetuned-eval-output"
LOG_BASE="pi05-finetuned-eval-logs"
...
echo "=== pi05_libero_finetuned_v044: Single-suite eval launcher ==="
...
BATCH_SCRIPT=$(mktemp /tmp/pi05_finetuned_eval.XXXX.sh)
...
echo ""
echo "=== Job submitted for pi05_libero_finetuned_v044 ==="
